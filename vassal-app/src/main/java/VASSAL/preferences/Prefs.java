...
import VASSAL.build.module.documentation.ai.RulesAssistantPrefs;
...
public class Prefs implements Closeable {
  ...
  protected synchronized void read() {
    ...
    try (RandomAccessFile raf = new RandomAccessFile(file, "rw")) {
      ...
      try (@SuppressWarnings({"try", "unused"}) FileLock lock = ch.lock()) { // NOPMD
  ...
  public static void initSharedGlobalPrefs() {
    ...
    RulesAssistantPrefs.addGlobalPreferences(globalPrefs);
  }
