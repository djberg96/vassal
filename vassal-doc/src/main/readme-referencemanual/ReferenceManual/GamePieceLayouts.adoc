...
*Bold:*:: When selected, draws this label in bold.

*Italic:*:: When selected, draws this label in italic.

*Outline:*:: When selected, draws an outline around this label's text.

*Outline thickness:*:: The thickness, in pixels, of the text outline.

*Outline color:*:: The color of the text outline. When the text is specified in individual images, each image can override this color.
