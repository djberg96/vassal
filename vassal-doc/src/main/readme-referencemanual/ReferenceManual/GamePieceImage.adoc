...
Vassal enforces that the name is a simple file name ending in '.svg' or '.png'.
New generated images use '.svg' by default.
...
*Bucket:*:: Optional image-selector bucket in which to list this generated image.
Buckets help organize large image lists and appear in image chooser controls.
